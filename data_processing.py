...
def save_features(id_train, id_test, ood_test, model_name, dataset_name, data = None):
    ...
    if data == 'agnews' :
        base_dir = f'/home/ids/fihey-23/project_contamination/initial_framework/embeddings_files/{model_name}/agnews/{dataset_name}/'       
    else :  
        base_dir = f'/home/ids/fihey-23/project_contamination/initial_framework/embeddings_files/{model_name}/{dataset_name}/' 
...
def create_datasets_nytimes(
    ...
    dataset_json_path="/home/ids/fihey-23/project_contamination/initial_framework/dataset/nytimes_dataset.json"
