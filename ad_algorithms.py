...
def ood_detection_every_combination(loss_fn_name, features_id_train, features_id_val, features_ood, post_proc_method, method, dataset_name, model_type, language, support_fraction = 0.6): 
    ...
    if method == 'ocsvm' : 
        ...
        file_path = f'/home/ids/fihey-23/new_code_contamination/results_tables_anomaly/{dataset_name}_results/{model_type}/{model_type}_ocsvm.tex'
    ...
    if method == 'lof' : 
        ...
        best_results = detection_performance(X_scores, Y_test, 'feats_logs', tag='TMP')
        file_path = f'/home/ids/fihey-23/new_code_contamination/results_tables_anomaly/{dataset_name}_results/{model_type}/{model_type}_lof.tex'
    ...
    if method == 'isolation_forest':
        ...
        best_results = detection_performance(X_scores, Y_test, 'feats_logs', tag='TMP')
        file_path = f'/home/ids/fihey-23/new_code_contamination/results_tables_anomaly/{dataset_name}_results/{model_type}/{model_type}_isolation_forest.tex'
    ...
    if method == 'knn': 
        ...
        file_path = f'/home/ids/fihey-23/new_code_contamination/results_tables_anomaly/{dataset_name}_results/{model_type}/{model_type}_knn.tex'
    ...
    if method == 'gmm': 
        ...
        file_path = f'/home/ids/fihey-23/new_code_contamination/results_tables_anomaly/{dataset_name}_results/{model_type}/{model_type}_gmm.tex'
    ...
    if method == 'lunar':
        ...
        file_path = f'/home/ids/fihey-23/new_code_contamination/results_tables_anomaly/{dataset_name}_results/{model_type}/{model_type}_lunar.tex'
    ...
    if method == 'autoencoder':
        ...
        results = detection_performance(X_scores, Y_test, 'feats_logs', tag='TMP')
        file_path = f'/home/ids/fihey-23/new_code_contamination/results_tables_anomaly/{dataset_name}_results/{model_type}/{model_type}_autoencoder.tex'
    ...
    if method == 'projection_depth': 
        ...
        file_path = (f'/home/ids/fihey-23/new_code_contamination/results_tables_anomaly/{dataset_name}_results/{model_type}/{model_type}_projection_depth.tex')
        append_to_latex_table(file_path, loss_fn_name, results)
    ...
    if method == 'l2_depth': 
        ...
        file_path = (f'/home/ids/fihey-23/new_code_contamination/results_tables_anomaly/{dataset_name}_results/{model_type}/{model_type}_l2_depth.tex')
        append_to_latex_table(file_path, loss_fn_name, results)
    ...
    if method == "geodesic_l2_depth":
        ...
        file_path = (
            f"/home/ids/fihey-23/new_code_contamination/results_tables_anomaly/{dataset_name}_results/{model_type}/"
